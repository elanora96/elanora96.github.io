...
const Home: FC = () => {
	...
	return (
		<main className={styles.main}>
			...
			<img
				alt="A cool looking skull with a construction hat and shovels crossing the background. Text is overlaid that says, &quot;Under Construction&quot;"
			...
			{/** biome-ignore lint/a11y/useMediaCaption: Not worth it */}
			<audio controls>
